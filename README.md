...
<body>
  <div class="container">
    <div class="header">
      <img src="./imagem/img.png" alt="Imagem perfil">
      ...
      <h2>Formação</h2>
      <ul>
        <li>Cursando: Analise e Desenvolvimento de Sistema(ADS) – UNIT (2025–2027)</li>
        <li> Curso: Nivel básico em Marketing Digital</li>
      ...
      <ul>
        <li>Tecnologias: HTML(básico), CSS(básico), Java(básico)</li>
